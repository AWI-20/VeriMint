...
void Edwards2Montgomery_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Edwards2Montgomery_2_run(uint ctx_index,Circom_CalcWit* ctx);
void MontgomeryDouble_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MontgomeryDouble_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Multiplexor2_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Multiplexor2_5_run(uint ctx_index,Circom_CalcWit* ctx);
void BitElementMulAny_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BitElementMulAny_6_run(uint ctx_index,Circom_CalcWit* ctx);
void Montgomery2Edwards_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Montgomery2Edwards_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
void SegmentMulAny_9_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void SegmentMulAny_9_run(uint ctx_index,Circom_CalcWit* ctx);
void SegmentMulAny_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void SegmentMulAny_10_run(uint ctx_index,Circom_CalcWit* ctx);
void EscalarMulAny_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void EscalarMulAny_11_run(uint ctx_index,Circom_CalcWit* ctx);
void Ecdh_12_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Ecdh_12_run(uint ctx_index,Circom_CalcWit* ctx);
void BuyerStageProof_13_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BuyerStageProof_13_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 8145;}

uint get_number_of_components() {return 1022;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 2561;}
...
MontgomeryDouble_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
Multiplexor2_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 7 ;
aux_cmp_num += 1;
}
...
MontgomeryDouble_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Multiplexor2_5_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
// load src
Fr_mul(&expaux[2],&circuitConstants[9],&signalValues[mySignalStart + 2]); // line circom 42
...
BitElementMulAny_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 29 ;
aux_cmp_num += 4;
}
...
Edwards2Montgomery_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4 ;
aux_cmp_num += 1;
}
...
Montgomery2Edwards_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4 ;
aux_cmp_num += 1;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Edwards2Montgomery_2_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
BitElementMulAny_6_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[11]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Montgomery2Edwards_7_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[108]{0};
}
...
uint csoffset = mySignalStart+3127;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "e2m";
Edwards2Montgomery_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+3148;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "m2e";
Montgomery2Edwards_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[14]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[103]].signalStart + 1]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[103]].signalStart + 2]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[103]].signalStart + 3]);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 4];
// load src
Fr_neg(&expaux[0],&signalValues[mySignalStart + 109]); // line circom 114
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
uint csoffset = mySignalStart+277;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "segments[0]";
SegmentMulAny_9_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
SegmentMulAny_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
uint aux_create = 3;
int aux_cmp_num = 2+ctx_index+1;
uint csoffset = mySignalStart+273;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "m2e";
Montgomery2Edwards_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
{
uint aux_create = 5;
int aux_cmp_num = 1017+ctx_index+1;
uint csoffset = mySignalStart+7871;
for (uint i = 0; i < 1; i++) {
...
// load src
Fr_mul(&expaux[1],&lvar[3],&circuitConstants[10]); // line circom 157
...
// load src
Fr_sub(&expaux[3],&circuitConstants[16],&signalValues[mySignalStart + 255]); // line circom 162
Fr_mul(&expaux[2],&expaux[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 162
Fr_add(&expaux[0],&signalValues[mySignalStart + 255],&expaux[2]); // line circom 162
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[3].offset+map_index_aux[0]];
// load src
Fr_sub(&expaux[3],&circuitConstants[17],&signalValues[mySignalStart + 256]); // line circom 163
Fr_mul(&expaux[2],&expaux[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 163
Fr_add(&expaux[0],&signalValues[mySignalStart + 256],&expaux[2]); // line circom 163
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
ctx->componentMemory[coffset].templateName = "Ecdh";
ctx->componentMemory[coffset].signalStart = soffset;
...
uint csoffset = mySignalStart+7879;
for (uint i = 0; i < 1; i++) {
...
EscalarMulAny_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 7874 ;
aux_cmp_num += 1019;
}
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EscalarMulAny_11_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[0]); // line circom 18
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 18
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[0]); // line circom 18
...
ctx->componentMemory[coffset].templateName = "BuyerStageProof";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "ecdh";
Ecdh_12_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 8133 ;
aux_cmp_num += 1021;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Ecdh_12_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 9];
// load src
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 9]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 10]); // line circom 28
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 1; i++){
...
BuyerStageProof_13_create(1,0,ctx,"main",0);
BuyerStageProof_13_run(0,ctx);
}
