...
include "../rely_modules/ecdh.circom";
...
template BuyerStageProof() {
    ...
    signal sharedSecret[2];    // ECDH shared secret
    ...
    // Compute the commitment inside the circuit (pesudo encryption)
...
component main{public [buyerPublicKey, commitment, modifiedCommitment]} = BuyerStageProof();
